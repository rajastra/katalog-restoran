...
var LikeButtonPresenter = {
  ...
  _renderLike: function _renderLike() {
    var _this4 = this;
    this._likeButtonContainer.innerHTML = (0,_views_templates_template_creator__WEBPACK_IMPORTED_MODULE_0__/* .createLikeRestoButtonTemplate */ .K7)();
  ...
  _renderLiked: function _renderLiked() {
    var _this5 = this;
    this._likeButtonContainer.innerHTML = (0,_views_templates_template_creator__WEBPACK_IMPORTED_MODULE_0__/* .createUnlikeRestoButtonTemplate */ .m4)();
    var likeButton = document.querySelector("#likeButton");
...
var DrawerInitiator = {
  init: function init(_ref) {
    ...
    button.addEventListener("click", function (event) {
      var btn = event.target.closest("#hamburgerButton");
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _data_therestaurant_source__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(380);
...
var FormReview = {
  init: function init(_ref) {
    var form = _ref.form,
      name = _ref.name,
      review = _ref.review,
      reviewContainer = _ref.reviewContainer;
    this._form = form;
    this._name = name;
    this._review = review;
  ...
  submitForm: function submitForm() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _this._form.addEventListener("submit", /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
                var url, data, response, userReview;
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    case 0:
                      event.preventDefault();
                      ...
                      data = {
                        ...
                        review: _this._review.value
                      };
                      _context.next = 5;
                      return _data_therestaurant_source__WEBPACK_IMPORTED_MODULE_0__/* ["default"].postReview */ .Z.postReview(data);
                    case 5:
                      response = _context.sent;
                      userReview = response.customerReviews[response.customerReviews.length - 1];
                      _this._reviewContainer.innerHTML += "\n         <div class=\"resto__review\">\n            <div class=\"resto__user\">\n               <img src=\"https://ui-avatars.com/api/?name=".concat(userReview.name, "\" alt=\"user\" class=\"resto__user-image\" />\n            </div>\n            <div class=\"resto__review-desc\">\n            <p>").concat(userReview.name, "</p>\n            <p class=\"resto__review-date\">").concat(userReview.date, "</p>\n            <p>").concat(userReview.review, "</p>\n            </div>\n         </div>");
                      if (response) {
                        _this._name.value = "";
                        _this._review.value = "";
                      }
